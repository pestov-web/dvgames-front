...
<template>
  <div class="pb-[100px]">
    ...
    <ul class="news__list">
      <li v-for="event in events.data.reverse()" class="news__card">
...
.news {
  ...
  &__card {
    @apply max-w-[210px] bg-blue-50 rounded-md overflow-hidden shadow-2xl flex flex-col justify-between;
